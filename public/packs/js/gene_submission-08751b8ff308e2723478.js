...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.zoomBtn').click(function () {
  zoomViewer(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('pos'));
});
var toggleAll = false;
...
function zoomViewer(position) {
  ...
  var locusString = "#{@chrom_start}:" + startCoord + "-" + endCoord; //const text = $("input[type=text]");
  ...
  var str = jquery__WEBPACK_IMPORTED_MODULE_0___default()("input").first();
  console.log(children.first().text()); //igv.browser.search(locusString);
...
/******/ });
//# sourceMappingURL=gene_submission-08751b8ff308e2723478.js.map