...
function zoomViewer(position) {
  ...
  var ta = jquery__WEBPACK_IMPORTED_MODULE_0___default()('form').find('input[type=text]').filter(':visible:first');
  console.log(ta.text()); //igv.browser.search(locusString);
...
/******/ });
//# sourceMappingURL=gene_submission-37f6883ee22dc35c844b.js.map