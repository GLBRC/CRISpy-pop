...
function zoomViewer(position, length, chrom) {
  ...
  var locusString = chrom + ":" + startCoord + "-" + endCoord; //const text = $("input[type=text]");
  //const ta = $('form').find('input[type=text]').filter(':visible:first');
  //ta.text(locusString);

  var children = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#igv-search-container').children();
  console.log(children.first().val());
  children.first().val(locusString); //igv.browser.search(locusString);
...
/******/ });
//# sourceMappingURL=gene_submission-df795345c97ffde90aea.js.map