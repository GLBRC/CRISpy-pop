...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.zoomBtn').click(function () {
  console.log('zooming');
  console.log(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('pos')); //zoomViewer();
});
var toggleAll = false;
...
function zoomViewer(position) {
  ...
  var text = jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[type=text]").text();
  console.log(text); //igv.browser.search(locusString);
...
/******/ });
//# sourceMappingURL=gene_submission-78a6d9c4a81dbe050721.js.map