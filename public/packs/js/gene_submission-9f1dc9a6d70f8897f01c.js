...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'igv.esm.min.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());

 //import "../stylesheets/igv.scss";
...
}; //const browser = igv.createBrowser(div, options);
...
function zoomViewer(position) {
  ...
  !(function webpackMissingModule() { var e = new Error("Cannot find module 'igv.esm.min.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).browser.search(locusString);
...
/******/ });
//# sourceMappingURL=gene_submission-9f1dc9a6d70f8897f01c.js.map